...
/*typedef struct {
  char coordX; \\ genre la lettre
  char coordY; \\ genre le chiffre
  SDL_Texture *texture; \\tab[0] pour le pion par exemple
}t_piece; */



SDL_Rect a1,b1,c1,d1,e1,f1,g1,h1,a2,b2,c2,d2,e2,f2,g2,h2,a3,b3,c3,d3,e3,f3,g3,h3,a4,b4,c4,d4,e4,f4,g4,h4,a5,b5,c5,d5,e5,f5,g5,h5,a6,b6,c6,d6,e6,f6,g6,h6,a7,b7,c7,d7,e7,f7,g7,h7,a8,b8,c8,d8,e8,f8,g8,h8,p_blanc,p_noir,tour_noir;
...
char CASE_ARRIVEE[2] = {'R','R'};

char CASE_DEPART[2] = {'R','R'};




void deplacement(SDL_Rect square);
...
int main(int argc, char* argv[])
{
    ...
    p_blanc.x = a2.x + (a2.w / RECAD);
    p_blanc.y = a2.y + (a2.h / RECAD);
    p_blanc.w = 80;
    p_blanc.h = 80;
    ...
    tour_noir.x = a8.x + (a8.w / RECAD);
    tour_noir.y = a8.y + (a8.h / RECAD);
    tour_noir.w = 80;
    tour_noir.h = 80;
    ...
    while (isOpen)
    {
        while (SDL_PollEvent(&events))
        {
            ...
            case SDL_MOUSEMOTION:
                ...
                //rectangle premier
                if ((mouse_x > p_blanc.x && mouse_x < p_blanc.x + p_blanc.w) && (mouse_y > p_blanc.y && mouse_y < p_blanc.y + p_blanc.h)) {
                    IsInSquare = 1;
                }
                else {
                    IsInSquare = 0;
            ...
            case SDL_MOUSEBUTTONDOWN:
               ...
               if (SDL_BUTTON_LEFT && !IsInSquare) {
                    mouse_left = 1;
                    SDL_Log("LE BOUTON EST CLIQUE");
               }
               else if (SDL_BUTTON_LEFT && IsInSquare) {
                   SDL_Log("GRAB");
                   if (GrabMode == 0) {
                       GrabMode = 1;
                   }
        ...
        SDL_RenderCopy(pRenderer, tab[0], NULL, &p_blanc);
